...
## To assist in line 80, I asked ChatGPT “I have two lists of genes (high and low loadings). How can I add a column to a dataframe to assigns loading categories to each rows?”
```
