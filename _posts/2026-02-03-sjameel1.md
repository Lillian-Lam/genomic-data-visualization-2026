...
Genes with higher variability tend to contribute more to PC1. In unscaled PCA, genes with higher variance disproportionately dominate PC1. In scaled PCA, variance differences are suppressed, and thus the curve is flatter but still increasing. Highly expressed genes (greater mean), have better signal-to-noise ratio, and thereforecontribute more to PC1. Scaling reduces but does not eliminate this trend.
